...
export class FallbackModel implements LanguageModelV1 {
  ...
  get supportsStructuredOutputs(): boolean {
    return this.settings.models[this.currentModelIndex].supportsStructuredOutputs!
  }
  ...
  get defaultObjectGenerationMode(): "json" | "tool" | undefined {
    return this.settings.models[this.currentModelIndex].defaultObjectGenerationMode
  }
